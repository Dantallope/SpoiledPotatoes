module.exports = {
    ...
    endDate: '2019-09-28',
    titles: [
      { title: 'Demon Slayer', language: 'x-jat', type: 'main' }
    ],
    description:
    ...
    endDate: '2014-09-24',
    titles: [
    { title: 'Hunter x hunter', language: 'x-jat', type: 'main' }
    ],
    description:
    ...
    endDate: '2022-06-25',
    titles: [
    { title: 'Spy x Family', language: 'x-jat', type: 'main' }
    ],
    description:
    ...
    endDate: '2013-03-24',
    titles: [
    { title: 'The Office', language: 'x-jat', type: 'main' }
    ],
    description:
    ...
    endDate: '2022-11-23',
    titles: [
    { title: 'Wensday', language: 'x-jat', type: 'main' }
    ],
    description:
    ...
    endDate: '2005-7-8',
    titles: [
    { title: 'Jackie Chan Adventures', language: 'x-jat', type: 'main' }
    ],
    description:
