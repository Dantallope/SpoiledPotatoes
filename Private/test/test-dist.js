const SP = require("../dist/bundle_umd.js");
const assert = require("assert");

const anime = SP().anime;
const user_animelist = SP().user_animelist;
const forum = SP().forum;
const manga = SP().manga;
const user_mangalist = SP().user_mangalist;
const user = SP().user;
